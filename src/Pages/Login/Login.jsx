                        ...
                        <form onSubmit={handleLogin}>
                            ...
                            <div className="space-y-3">
                                <a
                                    ...
                                    data-twe-ripple-color="light"
                                >
                                    <span className="mr-2 fill-white [&>svg]:mx-auto [&>svg]:h-3.5 [&>svg]:w-3.5">
                                ...
                                <a
                                    className="flex w-full items-center justify-center rounded bg-info px-7 pb-2.5 pt-3 text-center text-sm font-medium uppercase leading-normal text-white shadow-info-3 transition duration-150 ease-in-out hover:bg-info-accent-300 hover:shadow-info-2 focus:bg-info-accent-300 focus:shadow-info-2 focus:outline-none focus:ring-0 active:bg-info-600 active:shadow-info-2 dark:shadow-black/30 dark:hover:shadow-dark-strong dark:focus:shadow-dark-strong dark:active:shadow-dark-strong"
                                    ...
                                    data-twe-ripple-color="light"
                                >
                                    <span className="mr-2 fill-white [&>svg]:h-3.5 [&>svg]:w-3.5">
